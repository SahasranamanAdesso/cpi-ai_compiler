import { getSupportedComponentTypes } from './SupportedComponents';

/**
 * FlowValidator - Validates AI-generated Integration Flow code
 *
 * This class performs lightweight validation of TypeScript Integration Flow code
 * generated by the AI to ensure it uses the SAP Integration SDK correctly.
 *
 * The name "FlowValidator" reflects that this validates generated Integration Flow
 * code, not the SDK itself.
 *
...
export class FlowValidator {
    ...
    constructor() {
        // Load supported component types dynamically from SupportedComponents
        this.allowedComponentTypes = new Set(getSupportedComponentTypes());
    }
